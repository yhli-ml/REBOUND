...
#SBATCH -o /home/mila/j/jerry.huang/code_yuhangli/REBOUND/scripts/slurm-cifar10_lt_diffusemix-%j.out
...
cd "${PROJECT_ROOT}"
# =========================================================
# CIFAR-10-LT + DiffuseMix reference baseline: Two-stage pipeline
# =========================================================
