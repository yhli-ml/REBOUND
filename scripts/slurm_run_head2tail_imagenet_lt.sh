...
#SBATCH -o /home/mila/j/jerry.huang/code_yuhangli/REBOUND/scripts/slurm-imagenet_lt_head2tail-%j.out
...
# LORA_WEIGHTS=""  # Set to path above if using LoRA
...
# ---------------------------------------------------------------
# Step 3: Train baseline classifier on original images only
# ---------------------------------------------------------------
python main.py \
    --dataset ${DATASET} \
    --data_root ${DATA_ROOT} \
...
# ---------------------------------------------------------------
# Step 4: Generate Head-to-Tail augmented images
# ---------------------------------------------------------------
...
# ---------------------------------------------------------------
# Step 5: Train classifier with Head-to-Tail augmented data
# ---------------------------------------------------------------
python main.py \
    --dataset ${DATASET} \
    --data_root ${DATA_ROOT} \
